...
OPENSTACK_COMPONENT=os-ceilometer
...
################################################################################
#/bin/kubectl delete -f $namespace || echo "No Namespace to cleanup"
/bin/kubectl create -f $namespace || echo "Namespace exists"
...
echo "${OS_DISTRO}: ${OPENSTACK_COMPONENT}: ${OPENSTACK_SUBCOMPONENT}: Creating Namespace"
################################################################################
/bin/kubectl create -f $namespace || echo "Namespace Not Created"
