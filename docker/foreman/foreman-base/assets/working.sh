...
hammer -u admin -p ${FOREMAN_PASSWORD} host list
...
hammer -u admin -p ${FOREMAN_PASSWORD} template update --name "Kickstart default PXELinux" --file /tmp/kickstart-default
...
hammer -u admin -p ${FOREMAN_PASSWORD} template update --name "Atomic Kickstart default" --file /tmp/kickstart-default
...
hammer -u admin -p ${FOREMAN_PASSWORD} template update --name "Kickstart default" --file /tmp/kickstart-default

curl -L https://raw.githubusercontent.com/theforeman/community-templates/develop/kickstart/provision.erb > /tmp/kickstart-default
https://raw.githubusercontent.com/theforeman/community-templates/develop/snippets/puppet_setup.erb
