...
check_required_vars cfg KEYSTONE_ADMIN_SERVICE_HOST KEYSTONE_API_VERSION \
                    SERVICE_TENANT_NAME DESIGNATE_KEYSTONE_USER \
                    DESIGNATE_KEYSTONE_PASSWORD KEYSTONE_API_VERSION
...
crudini --set $cfg keystone_authtoken username "${DESIGNATE_KEYSTONE_USER}"
crudini --set $cfg keystone_authtoken password "${DESIGNATE_KEYSTONE_PASSWORD}"
crudini --set $cfg keystone_authtoken auth_version "v${KEYSTONE_API_VERSION}"
