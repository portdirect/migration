...
mysql -h ${MARIADB_SERVICE_HOST} \
      ...
      mysql <<EOF
CREATE DATABASE IF NOT EXISTS ${DESIGNATE_PDNS_DB_NAME} DEFAULT CHARACTER SET utf8 ;
GRANT ALL PRIVILEGES ON ${DESIGNATE_PDNS_DB_NAME}.* TO '${DESIGNATE_PDNS_DB_USER}'@'%' IDENTIFIED BY '${DESIGNATE_PDNS_DB_PASSWORD}';
EOF
