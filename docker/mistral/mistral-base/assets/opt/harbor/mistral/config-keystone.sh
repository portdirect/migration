...
check_required_vars cfg KEYSTONE_ADMIN_SERVICE_HOST KEYSTONE_API_VERSION \
                    ...
                    MISTRAL_KEYSTONE_PASSWORD KEYSTONE_API_VERSION
...
crudini --set $cfg keystone_authtoken username "${MISTRAL_KEYSTONE_USER}"
crudini --set $cfg keystone_authtoken password "${MISTRAL_KEYSTONE_PASSWORD}"
crudini --set $cfg keystone_authtoken auth_version "v${KEYSTONE_API_VERSION}"
...
export OS_USERNAME="${MISTRAL_KEYSTONE_USER}"
export OS_PASSWORD="${MISTRAL_KEYSTONE_PASSWORD}"
