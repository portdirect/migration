...
curl -b /etc/httpd/mellon/cookies \
    ...
    /usr/libexec/mod_auth_mellon/mellon_create_metadata.sh \
        https://keystone.${OS_DOMAIN}/keystone \
        https://keystone.${OS_DOMAIN}/v3/OS-FEDERATION/identity_providers/ipsilon/protocols/saml2/auth/mellon

    curl -L https://ipsilon.${OS_DOMAIN}/idp/saml2/metadata > /etc/httpd/mellon/idp-metadata.xml

    curl --cacert /etc/ipa/ca.crt --referer https://ipsilon.${OS_DOMAIN}/idp/rest/providers/saml2/SPS/keystone \
         -b /etc/httpd/mellon/cookies -c /etc/httpd/mellon/cookies \
         --data-urlencode metadata@/etc/httpd/mellon/https_keystone.${OS_DOMAIN}_keystone.xml\
         https://ipsilon.${OS_DOMAIN}/idp/rest/providers/saml2/SPS/keystone
