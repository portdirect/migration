...
crudini --set $cfg DEFAULT service_plugins "neutron.services.qos.qos_plugin.QoSPlugin,networking_ovn.l3.l3_ovn.OVNL3RouterPlugin,neutron_lbaas.services.loadbalancer.plugin.LoadBalancerPluginv2"
...
crudini --set $cfg_ml2 ovn ovn_l3_mode "True"
