    ...
    def _create_server_volume_heat(self, flavor, image_id,
        ...
        try:
            ...
            parameters = {"Flavor": flavor["name"],
                          ...
                          "TroveRabbitHost": CONF.oslo_messaging_rabbit.rabbit_host,
                          "TroveRabbitPort": CONF.oslo_messaging_rabbit.rabbit_port,
                          "TroveRabbitUser": CONF.oslo_messaging_rabbit.rabbit_userid,
                          "TroveRabbitPassword": CONF.oslo_messaging_rabbit.rabbit_password}
