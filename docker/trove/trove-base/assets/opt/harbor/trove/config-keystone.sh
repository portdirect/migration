...
check_required_vars cfg KEYSTONE_ADMIN_SERVICE_HOST KEYSTONE_API_VERSION \
                    SERVICE_TENANT_NAME TROVE_KEYSTONE_USER \
                    TROVE_KEYSTONE_PASSWORD KEYSTONE_API_VERSION
...
crudini --set $cfg keystone_authtoken username "${TROVE_KEYSTONE_USER}"
crudini --set $cfg keystone_authtoken password "${TROVE_KEYSTONE_PASSWORD}"
crudini --set $cfg keystone_authtoken auth_version "v${KEYSTONE_API_VERSION}"
...
export OS_USERNAME="${TROVE_KEYSTONE_USER}"
export OS_PASSWORD="${TROVE_KEYSTONE_PASSWORD}"
