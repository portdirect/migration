...
PUBLIC_ENDPOINT_URL="${KEYSTONE_AUTH_PROTOCOL}://trove.${OS_DOMAIN}/v1.0/\$(tenant_id)s"
INTERNAL_ENDPOINT_URL="${KEYSTONE_AUTH_PROTOCOL}://trove.${OS_DOMAIN}/v1.0/\$(tenant_id)s"
ADMIN_ENDPOINT_URL="${KEYSTONE_AUTH_PROTOCOL}://trove.${OS_DOMAIN}/v1.0/\$(tenant_id)s"
(
  (
    (
