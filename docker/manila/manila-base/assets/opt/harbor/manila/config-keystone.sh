...
check_required_vars cfg KEYSTONE_ADMIN_SERVICE_HOST KEYSTONE_API_VERSION \
                    SERVICE_TENANT_NAME MANILA_KEYSTONE_USER \
                    MANILA_KEYSTONE_PASSWORD KEYSTONE_API_VERSION
...
crudini --set $cfg keystone_authtoken username "${MANILA_KEYSTONE_USER}"
crudini --set $cfg keystone_authtoken password "${MANILA_KEYSTONE_PASSWORD}"
crudini --set $cfg keystone_authtoken auth_version "v${KEYSTONE_API_VERSION}"
...
export OS_USERNAME="${MANILA_KEYSTONE_USER}"
export OS_PASSWORD="${MANILA_KEYSTONE_PASSWORD}"
