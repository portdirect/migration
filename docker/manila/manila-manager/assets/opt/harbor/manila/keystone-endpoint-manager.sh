...
PUBLIC_ENDPOINT_URL="${KEYSTONE_AUTH_PROTOCOL}://manila.${OS_DOMAIN}/v1/\$(tenant_id)s"
INTERNAL_ENDPOINT_URL="${KEYSTONE_AUTH_PROTOCOL}://manila.${OS_DOMAIN}/v1/\$(tenant_id)s"
ADMIN_ENDPOINT_URL="${KEYSTONE_AUTH_PROTOCOL}://manila.${OS_DOMAIN}/v1/\$(tenant_id)s"
(
  (
    (
...
SERVICE_DESC="${OS_DISTRO}: $SERVICE_NAME service"
PUBLIC_ENDPOINT_URL="${KEYSTONE_AUTH_PROTOCOL}://manila.${OS_DOMAIN}/v2/\$(tenant_id)s"
INTERNAL_ENDPOINT_URL="${KEYSTONE_AUTH_PROTOCOL}://manila.${OS_DOMAIN}/v2/\$(tenant_id)s"
ADMIN_ENDPOINT_URL="${KEYSTONE_AUTH_PROTOCOL}://manila.${OS_DOMAIN}/v2/\$(tenant_id)s"
(
  (
    (
      SERVICE_ID=$( openstack service list \
