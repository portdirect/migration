...
check_required_vars BARBICAN_KEYSTONE_USER BARBICAN_KEYSTONE_PASSWORD \
...
PUBLIC_ENDPOINT_URL="${KEYSTONE_AUTH_PROTOCOL}://barbican.${OS_DOMAIN}"
INTERNAL_ENDPOINT_URL="${KEYSTONE_AUTH_PROTOCOL}://barbican.${OS_DOMAIN}"
ADMIN_ENDPOINT_URL="${KEYSTONE_AUTH_PROTOCOL}://barbican.${OS_DOMAIN}"
(
  (
    (
